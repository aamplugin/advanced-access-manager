...
if (defined('AAM_KEY')) { ?>
    <div class="aam-feature" id="configpress-content">
        <div class="row">
            <div class="col-xs-12">
                <p class="aam-info">
                    <?php echo sprintf(__('For detail about AAM configurations, refer to the %sConfigPress%s page.', AAM_KEY), '<a href="https://aamportal.com/plugin/advanced-access-manager/configpress/?ref=plugin">', '</a>'); ?>
                </p>
            </div>
        </div>
