    ...
    public function get_steps()
    {
        return apply_filters('aam_security_audit_checks_filter', [
            ...
            'roles_caps_naming_convention' => array(
                'title'       => __('Enforce Roles & Capabilities Naming Standards', 'advanced-access-manager'),
            ...
            'roles_visibility' => array(
                'title'       => __('Ensure Registered Roles Transparency', 'advanced-access-manager'),
                'step'        => 'roles_visibility',
                'category'    => 'Roles & Capabilities',
                'executor'    => AAM_Audit_RoleTransparencyCheck::class,
                'description' => __('Hidden roles can obscure access controls and create security risks by making it difficult to audit user permissions. This check flags hidden roles, helping you ensure full transparency and control over user access.', 'advanced-access-manager'),
            ...
            'empty_roles_detection' => array(
                ...
                'description' => __('Empty roles, which lack any assigned capabilities, can pose security risks if misused by plugins or themes. This check identifies such roles, enabling administrators to audit and remove them to avoid confusion and security vulnerabilities.', 'advanced-access-manager'),
            ...
            'high_privilege_users_count' => array(
                'title'       => __('Identified Elevated Number of High-Privilege Users', 'advanced-access-manager'),
