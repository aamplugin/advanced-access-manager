    ...
    <div>
        ...
        <?php if (!empty($policies)) { ?>
            <p class="post-attributes-label-wrapper parent-id-label-wrapper">
                <label class="post-attributes-label" for="parent_id"><?php _e('Parent', 'advanced-access-manager'); ?></label>
            </p>
            <?php echo $policies; ?>
		<?php } ?>
        <p class="post-attributes-label-wrapper menu-order-label-wrapper">
            <label class="post-attributes-label" for="menu_order"><?php _e('Order', 'advanced-access-manager'); ?></label>
        </p>
