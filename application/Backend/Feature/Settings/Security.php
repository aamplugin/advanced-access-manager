    ...
    public static function getList()
    {
        $settings = array(
            'service.secureLogin.feature.singleSession' => array(
                ...
                'description' => sprintf(AAM_Backend_View_Helper::preparePhrase('Automatically destroy all other sessions for a user if he/she tries to login from different location. For more information refer to the %sOne Session Per User%s page.', 'strong', 'strong'), '<a href="https://aamportal.com/plugin/advanced-access-manager/setting/one-session-per-user?ref=plugin" target="_blank">', '</a>'),
            ...
            'service.secureLogin.feature.bruteForceLockout' => array(
                ...
                'description' => sprintf(AAM_Backend_View_Helper::preparePhrase('Automatically reject login request if number of unsuccessful attempts exceeds 20 over the period of 2 minutes (both values are configurable). For more information refer to the %sBrute Force Lockout%s page.', 'strong', 'strong'), '<a href="https://aamportal.com/plugin/advanced-access-manager/setting/bruteforce-lockout?ref=plugin" target="_blank">', '</a>'),
