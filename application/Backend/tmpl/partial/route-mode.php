    ...
    <div class="aam-feature-top-actions text-right">
        <table class="table table-bordered">
            <tbody>
                <tr class="aam-info">
                    <td class="text-left">
                        <?php echo sprintf(AAM_Backend_View_Helper::preparePhrase('[Premium Feature:] Operate the RESTful API in a restricted access mode. When set to "Enabled," all current and future RESTful API endpoints are restricted by default unless explicitly permitted. %sLearn more%s.', 'strong'), '<a href="https://aamportal.com/plugin/premium-complete-package/restful-api-access/restricted-mode?ref=plugin" target="_blank">', '</a>'); ?>
                    </td>
